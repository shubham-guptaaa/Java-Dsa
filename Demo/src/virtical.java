...
public class virtical {
    ...
    public static List<List<Integer>> findVertical(Node root) {
        ...
        while (!todo.isEmpty()) {
            ...
            // in the map
            nodes.computeIfAbsent(x, _ -> new TreeMap<>())
                 .computeIfAbsent(y, _ -> new TreeSet<>())
                 .add(temp.data);
    ...
    public static void main(String[] args) {
        ...
        List<List<Integer>> verticalTraversal = virtical.findVertical(root);
